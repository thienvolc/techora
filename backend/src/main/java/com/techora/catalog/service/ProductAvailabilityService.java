...
public class ProductAvailabilityService {
    ...
    @Transactional
    public ProductEntity getLockedAvailableProductOrThrow(UUID productId) {
        ProductEntity product = repository.findLockedWithCategoryById(productId)
    ...
    @Transactional
    public ProductSnapshot getLockedAvailableSnapshotOrThrow(UUID productId) {
        return mapper.toSnapshot(
                getLockedAvailableProductOrThrow(productId));
    }
}
